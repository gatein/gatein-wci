 ...
 */
package org.gatein.wci.test.jboss7.deployment;
...
public class DeploymentTestCase extends AbstractDeploymentTestCase
{
   ...
   {
      WebArchive war = wciJBoss7Deployment("deploymentwci.war");
      war.addClass(AbstractDeploymentTestCase.class);
      war.setWebXML("org/gatein/wci/test/jboss7/deployment/web.xml");
